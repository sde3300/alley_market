    ...
    <div class="container mr-auto">
        ...
        <div class="container">
            <form>
                ...
                <div class="row">
                    <button type="button" class="btn btn-primary col-sm-2 ml-auto" id="btnmodi">등록하기</button>
                    <button type="button" class="btn btn-warning col-sm-2" id="btnmodi">수정하기</button>
