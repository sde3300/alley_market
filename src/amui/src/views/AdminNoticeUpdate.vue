<template>
    <div class="container mr-auto">
        ...
        <hr>
        <div class="container" id="noticemodi">
            <form>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control-plaintext" id="exampleFormControlInput1" placeholder="이름을 입력하세요" v-model="createId">
                    </div>
                </div>
                ...
                <div class="row ">
                    ...
                    <button type="button" class="btn btn col-sm-1 " id="btnwrite" v-on:click = "AdminNoticeUpdate">수정하기</button>
                </div>
            </form> 
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        AdminNoticeUpdate() {
            ...
            obj.$axios.post('http://18.220.212.146:9000/noticeUpdate', formData, {
        ...
        //     let obj =this;
        //     this.$axios
        //         .put('http://localhost:9000/noticeUpdate', {
        //             noticePk: this.noticePk,
        //             noticeTitle: this.noticeTitle,
        //             noticeContents: this.noticeContents,
